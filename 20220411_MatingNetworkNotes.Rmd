...
four_graph_seq <- list(c("CR_F", "WG_F", "C_F", "GB_F", "WY_F", "CY_F", "CB_F", "YR_F", "GR_F", "R_F"), c("G_M", "CG_M", "WC_M", "YB_M", "YG_M", "B_M", "R_M", "C_M", "CB_M", "WR_M"))
names(four_graph_seq) <- c("seq.high", "seq.low")
...
for(i in 1:25){
  ...
  sub_graph <- simplify(sub_graph, edge.attr.comb=list(weight="sum"))
  sub_adj <- as_adjacency_matrix(sub_graph, sparse = F, attr = "weight")
  sub_adj_trim <- sub_adj[-c(1:10), 1:10]
  result[[i]] <- print(sub_adj_trim)
} 
