...
I realize that to extract density and strength, we need a dataframe that includes all flies to calculate things properly. Then, I can try to visualize histograms of these metrics
...
#visualize the distributions of density
ggplot(global_summary, aes(x = trial_names, y = densities)) +
  facet_wrap(~temp) +
  geom_boxplot()

#visualize the distributions of strength
ggplot(global_summary, aes(x = strengths)) +
  facet_wrap(~temp) +
  geom_histogram()
```
